...
- A real finalist-board demo in the README: `docs/assets/board.webp`
  captured from a live planning run of the canonical warm-beachy ask
  (neutral profile, live seats.aero data), with the board doc committed
  as `docs/scripts/demo-board.json` and the screenshot regenerated by
  `docs/scripts/demo.sh` (cc-present render + agent-browser capture).
