...
- A real finalist-board demo in the README: `docs/assets/board.webp`,
  ...
  a live planning run of the canonical warm-beachy ask on the leg-intent
  engine (the P5 regression capstone run: funded profile, live
  seats.aero data, real assess verdicts), carrying rank's own output —
  six ranked journeys plus its notable stretch. `docs/scripts/demo.sh`
  regenerates the capture.
