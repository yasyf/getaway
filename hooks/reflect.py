...
REFLECT = (
    ...
    "avoids, travel documents — passports, residency, and standing visas ('I have a Canadian "
    "passport') — in the documents key, and layover tastes — the minimize-or-explore style, the shortest "
    "connection the user will accept, and cities they'd welcome or avoid for a long stop ('I'd happily "
    "spend a day in Istanbul') — in the layovers key. "
